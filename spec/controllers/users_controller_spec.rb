...
describe UsersController do
  ...
  describe "PUT 'update' " do
   ...
   describe "access to new/create actions" do
     before(:each) do
       @user = Factory(:user)
     end
     
     it "post :create should be denied for signed-in users" do
       test_sign_in(@user)
       post :create
       response.should redirect_to(root_path)
     end
     
     it "get :new should be denied for signed-in users" do
       test_sign_in(@user)
       get :new
       response.should redirect_to(root_path)
     end
   ...
   describe "DELETE 'destroy'" do
     ...
     describe "as an admin user" do
       ...
       it "should see the delete links" do
         get :index
